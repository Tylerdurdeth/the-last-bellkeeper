...
Current rebuild camera:42° vertical FOV, fixed yaw with gently eased valley reveal, ordinary distance13.2m portrait/14.2m landscape. Three-dimensional landscape replaces the18×14m terrace specification above. Near foliage fades across an action window containing hero, staff and interactable; materials start transparent to keep transitions effective. Crown variantB uses rounded shallow-lobed leaves and open branch gaps instead of spear-shaped curtains. Fog#8caea1, warm sun#ffe1ae and cool hemisphere shadow#274d54 establish depth. Ground, bark and stone retain painted Atlas surface variation subordinate to silhouette and path values.

Story props belong to a specific absent keeper, Mara: a note/tool pegs by the cottage, keepsakes from her daily route, and the far-bank morning bell. Garden motion teaches the active current; warm flowers answer the carried wind along a short return shelf. These are authored environmental cues, not target arrows or a forced collection gate.
