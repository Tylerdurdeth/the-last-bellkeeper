...
cyl(.023,.032,1.08,wood,0,.54,0);for(let i=0;i<5;i++)cyl(.036,.036,.017,copper,0,.42+i*.034,0);add(new T.TorusGeometry(.072,.013,7,18),copper,0,1.14,0);cyl(.027,.084,.105,copper,0,1.035,0);ball(dark,0,.976,0,.018,.023,.018);
