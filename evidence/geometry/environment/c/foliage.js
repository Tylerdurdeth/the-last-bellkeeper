export default function (T) {
  ...
  ell(g,deep,0,.10,0,.59,.12,.48);
  for(let i=0;i<13;i++){const a=i*2.399,rad=.20+(i%3)*.15;const x=Math.cos(a)*rad,z=Math.sin(a)*rad,y=.27+(i%4)*.105;beam(g,wood,[0,.05,0],[x,y,z],.012);const o=ell(g,i%3?leaf:leafLight,x,y,z,.17,.13,.32);o.rotation.y=-a;o.rotation.z=Math.cos(a)*.4;}
