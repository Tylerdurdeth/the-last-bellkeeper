...
void main() {
  #ifdef BK_FADE
  {
    ...
    for ( int i = 0; i < 4; i ++ ) {
      ...
      float f = smoothstep( 0.35, 0.65, ( 1.0 - smoothstep( 0.94, 1.02, length( d ) ) ) * smoothstep( 1.1, 1.3, A.z - vDepth ) * max( 1.0 - flatS, smoothstep( B.x + 1.0, B.x + 1.3, vWorld.y ) ) ) * B.z;   // same rule as toon.js
