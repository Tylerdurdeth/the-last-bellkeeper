...
export const STORY=[
 ...
 {heading:'One keeper. One apprentice.',text:'Mara stays behind to work the old bypass. Her bell staff waits for you by the cottage door—and somewhere below, the wind is trying to say something.'}
];
