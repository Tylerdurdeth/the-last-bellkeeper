export default function(THREE) {
 ...
 const faceGeo=(()=>{const g=new THREE.SphereGeometry(1,48,40),p=g.attributes.position;for(let i=0;i<p.count;i++){const y=p.getY(i),jaw=y<0?1-.34*(-y):1;let z=p.getZ(i)*.098;if(z>0)z=Math.pow(z/.098,.68)*.098;p.setXYZ(i,p.getX(i)*.116*jaw,.15+y*.142,z);}return g;})();
