export default function(THREE) {
 ...
 const faceGeo=(()=>{const g=new THREE.SphereGeometry(1,48,40),p=g.attributes.position;for(let i=0;i<p.count;i++){const y=p.getY(i),jaw=y<0?1-.20*(-y):1;p.setXYZ(i,p.getX(i)*.115*jaw,.15+y*.145,p.getZ(i)*.10);}return g;})();
