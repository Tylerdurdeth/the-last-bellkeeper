...
const SHOTS = ['street', 'maraWorkshop', 'maraOutlet', 'morningBell', 'seedWheelGate', 'loftVent', 'loft', 'sailsBridge', 'sailsMillIdle', 'sailsCapSail', 'sailsMillRestored', 'pipesValve', 'pipesMillIdle', 'pipesMillRestored', 'laddersShutter', 'laddersMillRestored', 'fragment1', 'fragment2', 'fragment3', 'skyBridge', 'hollowGate', 'galleryCarvings', 'wellHigh', 'wellMid', 'wellLow', 'topPerch', 'pairedBells', 'finale'];
